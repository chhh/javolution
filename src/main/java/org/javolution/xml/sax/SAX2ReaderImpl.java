 ...
 */
package org.javolution.xml.sax;
...
public final class SAX2ReaderImpl implements XMLReader {
    ...
    private static final class Proxy implements
            org.javolution.xml.sax.ContentHandler, Attributes {
         ...
         * values are read.
         */
        private org.javolution.xml.sax.Attributes _attributes;
        ...
        public void startElement(CharArray namespaceURI, CharArray localName,
                CharArray qName, org.javolution.xml.sax.Attributes atts)
                throws SAXException {
            _attributes = atts;
